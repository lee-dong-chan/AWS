...
comment.forEach((comment1) => {
  ...
  <div class="content">
    ...
    <p class="menu"><a href="./"><span>신고</span></a><a href="./"><span><img src="../imgs/스크린샷 2024-05-01 오후 4.59.27.png"><span><span>답글쓰기</span></a></p>
  </div>
</div>`;
    comment1.recomment.forEach((comment2) => {
     ...
     <div class="empty"></div>
      ...
      <div class="content">
        ...
        <p class="menu"><a href="./"><span>신고</span></a><a href="./"><span><span><img src="../imgs/스크린샷 2024-05-01 오후 4.59.27.png">답글쓰기</span></a></p>
      </div>
    </div>`;
    });
  }
